...
class Angsuran extends MY_Controller
{
	...
	{
    $data['angsuran'] = $this->Angsuran_model->getListAngsuran(); // Mengubah data yang dikirim ke view
    $data['anggota'] = $this->Anggota_model->getAll(); // Menambah data anggota
    $this->load->view("angsuran/angsuran_anggota", $data); // Mengirim data anggota ke view
	}
