...
$write->save('php://output');
    ...
    public function export_pdf() {
        ...
        $html .= '<th style="text-align:center">Simpanan Wajib</th>'; // Tambahkan kolom untuk simpanan pokok
        $html .= '</tr>';
        $no = 1;
    ...
    $total_simpanan_wajib_per_anggota = array();
    $total_simpanan_wajib_anggota = $this->SimpananWajib_model->total_simpanan_wajib_per_anggota();
    foreach ($total_simpanan_wajib_anggota as $total) {
        $total_simpanan_wajib_per_anggota[$total->id_anggota] = $total->total_simpanan_wajib;
    }
