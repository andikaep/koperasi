...
if (isset($headerdata['logo_width']) && is_numeric($headerdata['logo_width'])) {
    if ($this->getRTL()) {
    ...
    // Set default value for $header_x if $headerdata['logo_width'] is not available or not numeric
    $header_x = $this->original_lMargin;
}
$cw = $this->w - $this->original_lMargin - $this->original_rMargin - ($header_x * 1.1);
