...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('simpanan_sukarela/index') ?>"><i class="fa fa-fw fa-child"></i>Lihat Data Anggota</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <h3 class="box-title">Tambah Simpanan Sukarela <strong><?php echo $anggota->nama; ?></strong></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('simpanan_sukarela/add/'.$anggota->id_anggota) ?>" method="post">
              <input type="hidden" name="id_anggota" value="<?php echo $anggota->id_anggota?>" />

              <div class="box-body">
                <div class="form-group">
                  <label>Jumlah</label>
                  <input name="jumlah" id="jumlah" class="form-control <?php echo form_error('jumlah') ? 'is-invalid':'' ?>" placeholder="Masukkan Jumlah Simpanan Sukarela" type="text" onkeyup="formatRupiah(this)">
...
<div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="confirmModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <h4> Anda akan menambahkan <strong>Simpanan Sukarela </strong> atas nama:</h4>
