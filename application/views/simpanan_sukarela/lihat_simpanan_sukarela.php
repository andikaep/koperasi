        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              ...
              <a href="<?php echo base_url("simpanan_sukarela/export"); ?>" class="btn btn-carot"><i class="fa fa-fw fa-file-excel-o"></i>Export Excel</a>
              <a href="<?php echo base_url("simpanan_sukarela/export_pdf"); ?>" class="btn btn-ijo"><i class="fa fa-fw fa-file-pdf-o"></i>Export PDF</a>
              </div>
              <!-- /.box-header -->
