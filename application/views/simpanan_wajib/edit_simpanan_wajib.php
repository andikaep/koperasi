  ...
  <div class="content-wrapper">
      ...
      <?php if ($this->session->flashdata('success')): ?>
        <div class="box-body">
          <div class="alert alert-info alert-dismissible">
            ...
            <a href="<?php echo base_url('simpanan_wajib/detail/'.$simpanan_wajib->id_anggota) ?>">Saya Mengerti</a>
          </div>
        </div>
      <?php endif; ?>
      <!-- Alert -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('simpanan_wajib/index') ?>">Lihat Anggota</a></li>
        <li><a href="<?php echo base_url('simpanan_wajib/detail/'.$simpanan_wajib->id_anggota) ?>">Lihat Detail Simpanan Wajib Anggota</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <h3 class="box-title">Ubah Simpanan Wajib <strong><?php echo $anggota->nama; ?></strong></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('simpanan_wajib/edit/'.$simpanan_wajib->id_simpanan_wajib) ?>" method="post">
              <input type="hidden" name="id_anggota" value="<?php echo $simpanan_wajib->id_anggota?>" />

              <div class="box-body">
                <div class="form-group">
                  <label>Jumlah</label>
                  <input name="jumlah" id="jumlah" class="form-control <?php echo form_error('jumlah') ? 'is-invalid':'' ?>" placeholder="Masukkan Jumlah Simpanan Wajib" value="<?php echo $simpanan_wajib->jumlah?>" type="text" onkeyup="formatRupiah(this)">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <h4>Anda akan mengubah simpanan wajib <strong><?php echo $anggota->nama; ?></strong></h4>
        <h4 class="font-weight-bold mb-4"><strong id="modalJumlah"><?php echo $simpanan_wajib->jumlah;  ?></strong></h4>
        <h4 class="text-muted">Menjadi <span id="modalNewJumlah"></span></h4>
      </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Perbarui nilai terbilang saat halaman dimuat
        if (inputJumlah) {
            var jumlah = inputJumlah.value.replace(/[^\d]/g, ''); // Ambil nilai angka dari input jumlah
            if (jumlah) {
