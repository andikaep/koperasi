        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <div class="box-body table-responsive">
              ...
              <div class="box-header">
                 <a href="<?php echo base_url("simpanan_wajib/export_detail/$id_anggota"); ?>" class="btn btn-carot"><i class="fa fa-fw fa-file-excel-o"></i>Export Excel</a>
                 <a href="<?php echo base_url("simpanan_wajib/export_detail_pdf/$id_anggota"); ?>" class="btn btn-ijo"><i class="fa fa-fw fa-file-pdf-o"></i>Export PDF</a>

              </div>
           <?php if (!empty($simpanan_wajib)) : ?>
    <?php $nama = $simpanan_wajib[0]->nama; ?>
    <?php $nia = $simpanan_wajib[0]->nia; ?>
...
<div class="row">
    <div class="col-md-6">
        <form method="post" action="<?php echo base_url("simpanan_wajib/filterByDate/$id_anggota"); ?>">
