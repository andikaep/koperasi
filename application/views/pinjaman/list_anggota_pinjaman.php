  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="<?php  echo base_url('pinjaman') ?>"><i class="fa fa-fw fa-money"></i> Lihat Pinjaman</a></li>
                  ...
                  <tbody>
                    ...
                    <?php foreach ($anggota as $value): ?>
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-primary" href="<?php echo site_url('pinjaman/add/'.$value->id_anggota) ?>"><i class="fa fa-fw fa-plus"></i>Pinjaman</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
