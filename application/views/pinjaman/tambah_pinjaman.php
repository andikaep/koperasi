...
$lastPinjaman = $this->db->query("SELECT MAX(CAST(no_pinjaman AS UNSIGNED)) AS last_pinjaman FROM pinjaman")->row()->last_pinjaman;
...
?>
    ...
    <p id="terbilang" class="form-control-static"></p>
                ...
                <div class="form-group">
                  <label>Bunga (%)</label>
                  <input name="bunga" id="bunga" name="bunga" class="form-control <?php echo form_error('bunga') ? 'is-invalid':'' ?>" placeholder="Masukan Jumlah Bunga" type="text" />
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <h4>Anda akan menambahkan <strong> Pinjaman </strong>atas nama:</h4>
