		...
		<?php if ($this->session->flashdata('success')): ?>
			<div class="box-body">
				<div class="alert alert-info alert-dismissible">
					...
					<h4><i class="icon fa fa-info"></i>Alertdddd!</h4>
				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							<form method="post" action="<?php echo base_url("anggota/form"); ?>"
								...
								<div class="form-group">
									<input class="btn btn-success" type="submit" name="preview" value="Lihat Data">
									<a class="btn btn-carot" href="<?php echo base_url("excel/format_anggota.xlsx"); ?>">Download Format</a>
								</div>
							</form>
						</div>
						<!-- /.box-header -->
						<div class="box-body table-responsive">
							...
							if (isset($_POST['preview'])) { // Jika user menekan tombol Preview pada form
								...
								echo "<form method='post' action='" . base_url("anggota/import") . "'>";
								...
								foreach ($sheet as $row) {
									...
									if (empty($no) && empty($nia) && empty($nama) && empty($jenis_kelamin) && empty($alamat))
									...
									if ($numrow > 1) {
										...
										if (empty($nia) or empty($nama) or empty($jenis_kelamin) or empty($alamat)) {
								...
								if ($kosong > 0) {
                					...
                					<a href='" . base_url("anggota") . "' class=\"btn btn-danger\" type=\"reset\"><i style=\"margin-left: -3px;\" class=\"fa fa-fw fa-times\"></i>Batal</a>
              						</div>";
								}
