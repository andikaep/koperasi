	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo base_url('pegawai')?>">Lihat Data Pegawai</a></li>
			</ol>
		</section>
				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							<form method="post" action="<?php echo base_url("pegawai/form"); ?>"
						...
						<div class="box-body table-responsive">
							...
							if (isset($_POST['preview'])) { // Jika user menekan tombol Preview pada form
								...
								echo "<form method='post' action='" . base_url("pegawai/import") . "'>";
								...
								if ($kosong > 0) {
                					...
                					<a href='" . base_url("pegawai") . "' class=\"btn btn-danger\" type=\"reset\"><i style=\"margin-left: -3px;\" class=\"fa fa-fw fa-times\"></i>Batal</a>
              						</div>";
								}
