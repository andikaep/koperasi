      ...
      <?php if ($this->session->flashdata('success')): ?>
        <div class="box-body">
          <div class="alert alert-info alert-dismissible">
            ...
            <a href="<?php echo base_url('angsuran/') ?>">Saya Mengerti</a>
          </div>
        </div>
      <?php endif; ?>
      <!-- Alert -->
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('angsuran/edit/'.$angsuran->id_angsuran) ?>" method="post">
              <input type="hidden" name="id_pinjaman" value="<?php echo $angsuran->id_pinjaman?>" />

              <div class="box-body">
                <div class="form-group">
                  <label>No Angsuran</label>
                  <input name="no_angsuran" class="form-control <?php echo form_error('no_angsuran') ? 'is-invalid':'' ?>" placeholder="Masukan No Angsuran" type="text" value="<?php echo $angsuran->no_angsuran?>" readonly/>
                ...
                <div class="form-group">
                  ...
                  <input name="jumlah_angsuran" id="jumlah" class="form-control <?php echo form_error('jumlah_angsuran') ? 'is-invalid':'' ?>" placeholder="Masukan Jumlah Angsuran Tanpa (.)" type="text" value="<?php echo $angsuran->jumlah_angsuran?>" onkeyup="formatRupiah(this)"/>
                  <div class="invalid-feedback">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <h4>Anda akan mengubah angsuran menjadi <span id="modalNewJumlah"></span></h4>
      </div>
