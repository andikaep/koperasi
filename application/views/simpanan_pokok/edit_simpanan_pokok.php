      ...
      <?php if ($this->session->flashdata('success')): ?>
        <div class="box-body">
          <div class="alert alert-info alert-dismissible">
            ...
            <a href="<?php echo base_url('simpanan_pokok/detail/'.$simpanan_pokok->id_anggota) ?>">Saya Mengerti</a>
          </div>
        </div>
      <?php endif; ?>
      <!-- Alert -->
...
<?php endif; ?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('simpanan_pokok/index') ?>">Lihat Anggota</a></li>
        <li><a href="<?php echo base_url('simpanan_pokok/detail/'.$simpanan_pokok->id_anggota) ?>">Lihat Detail Simpanan Pokok Anggota</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <h3 class="box-title">Ubah Simpanan Pokok <strong><?php echo $anggota->nama; ?></strong></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('simpanan_pokok/edit/'.$simpanan_pokok->id_simpanan_pokok) ?>" method="post">
              <input type="hidden" name="id_anggota" value="<?php echo $simpanan_pokok->id_anggota?>" />

              <div class="box-body">
                <div class="form-group">
                  <label>Jumlah</label>
                  <input name="jumlah" id="jumlah" class="form-control <?php echo form_error('jumlah') ? 'is-invalid':'' ?>" placeholder="Masukkan Jumlah Simpanan Pokok" value="<?php echo $simpanan_pokok->jumlah?>" type="text" onkeyup="formatRupiah(this)">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <h4>Anda akan mengubah simpanan pokok <strong><?php echo $anggota->nama; ?></strong></h4>
        <h4 class="font-weight-bold mb-4"><strong id="modalJumlah"><?php echo $simpanan_pokok->jumlah;  ?></strong></h4>
