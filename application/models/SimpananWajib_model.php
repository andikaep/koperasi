...
class SimpananWajib_model extends CI_Model
{
 ...
 //        return $query->result();
	...
	public function total_simpanan_wajib_by_filter($year = null, $month = null, $start_date = null, $end_date = null) {
		$this->db->select_sum('jumlah');
		$this->db->from('simpanan_wajib as s');
		$this->db->join('anggota as a', 's.id_anggota = a.id_anggota');
	...
	public function total_simpanan_wajib_all_export($year = null, $month = null, $start_date = null, $end_date = null) {
	...
	public function total_simpanan_wajib_all_detail($year = null, $month = null, $start_date = null, $end_date = null) {
		$this->db->select('anggota.id_anggota, SUM(simpanan_wajib.jumlah) AS total_simpanan_wajib');
		...
		foreach ($result as $row) {
			$totals[$row->id_anggota] = $row->total_simpanan_wajib;
		}
	...
	public function total_simpanan_wajib_per_anggota_by_date_range($start_date, $end_date) {
		$this->db->select('id_anggota, SUM(jumlah) AS total_simpanan_wajib');
		$this->db->from('simpanan_wajib');
		$this->db->where('tanggal_dibayar >=', $start_date);
		$this->db->where('tanggal_dibayar <=', $end_date);
	...
	public function total_simpanan_wajib_per_anggota_by_year_month($year, $month) {
		$this->db->select('id_anggota, SUM(jumlah) AS total_simpanan_wajib');
		$this->db->from('simpanan_wajib');
		$this->db->where('YEAR(simpanan_wajib.tanggal_dibayar)', $year);
		$this->db->where('MONTH(simpanan_wajib.tanggal_dibayar)', $month);
	...
	public function total_simpanan_wajib_per_anggota_by_year($year) {
		$this->db->select('id_anggota, SUM(jumlah) AS total_simpanan_wajib');
		$this->db->from('simpanan_wajib');
		$this->db->where('YEAR(simpanan_wajib.tanggal_dibayar)', $year);
		$this->db->group_by('id_anggota');
